...
<div class = "card-body">
	...
	<table class = "table table-striped table-sm" style = "table-layout: fixed; width: 100%;">
		...
		<!-- Today -->
		<tbody id = "day0">
		<c:forEach items = "${forecast_Data[0]}" var = "list">
			<tr>
				<td>${list.time}</td>
				<td>${list.country}</td>
		...
		<c:forEach items = "${forecast_Data[1]}" var = "list">
			<tr>
				<td>${list.time}</td>
				<td>${list.country}</td>
				<td>${list.countryISOCode}</td>
		...
		<c:forEach items = "${forecast_Data[2]}" var = "list">
			<tr>
				<td>${list.time}</td>
				<td>${list.country}</td>
				<td>${list.countryISOCode}</td>
		...
		<c:forEach items = "${forecast_Data[3]}" var = "list">
			<tr>
				<td>${list.time}</td>
				<td>${list.country}</td>
				<td>${list.countryISOCode}</td>
		...
		<c:forEach items = "${forecast_Data[4]}" var = "list">
			<tr>
				<td>${list.time}</td>
				<td>${list.country}</td>
				<td>${list.countryISOCode}</td>
